...
class BFSAI(AIBase):
    def run(self):
        ...
        while True:
            ...
            if self.difficulty == "dificil" and empty_turns >= 4:
                break
    ...
    def run_visual(self, screen, clock):
        ...
        while True:
            ...
            won = self.board.score >= {"facil": 1000, "medio": 2000, "dificil": 3000}[self.difficulty]
            lost = self.difficulty == "dificil" and empty_turns >= 4

            if not move_made or self.board.is_game_over(self.pieces) or won or lost:
                return {
                    "algoritmo": "BFS",
                    "pontuacao": self.board.score,
                    "passos": steps,
                    "tempo": time.time() - start_time,
                    "venceu": won and not lost,
                    "delay_ms": delay_ms
                }
    ...
    def _draw_ia_info(self, screen, steps, delay):
        ...
        info = f"IA: BFS   |   Steps: {steps}   |   Delay: {delay}ms"
